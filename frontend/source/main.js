...
mapboxgl.accessToken =
  "pk.eyJ1IjoiYWJla2tlciIsImEiOiJjbTN3NGxoZTMxM2cwMmpwdTNjODEyMXBvIn0.9o4pgS4R2dJUmwKJseNr5A";
...
function addMarkersToMap(events) {
  ...
  if (features.length > 0) {
    // Avoid error if no features exist
